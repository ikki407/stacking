...
FEATURE_LIST_stage1 = {
                'train':('data/output/features/ikki_features_train_ver2.csv',
                         'data/output/features/ikki_one_hot_encoder_train_ver2.csv',
                         
                        ),#target is in 'train'
                'test':('data/output/features/ikki_features_test_ver2.csv',
                        'data/output/features/ikki_one_hot_encoder_test_ver2.csv',
                        ),
                }
