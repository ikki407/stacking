...
def main_feat(train, test, sample_submit=None):
    ...
    train.to_csv('data/output/features/ikki_features_train_ver1.csv',index=None)
    test.to_csv('data/output/features/ikki_features_test_ver1.csv',index=None)
...
def main_feat_NN():
    ...
    train.to_csv('data/output/features/ikki_features_train_NN_ver1.csv',index=None)
    test.to_csv('data/output/features/ikki_features_test_NN_ver1.csv',index=None)
...
def one_hot_encoder(train, test):
    ...
    train.to_csv('data/output/features/ikki_one_hot_encoder_train_ver1.csv',index=None)
    test.to_csv('data/output/features/ikki_one_hot_encoder_test_ver1.csv',index=None)
