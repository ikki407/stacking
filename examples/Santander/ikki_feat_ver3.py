...
def main_feat(train, test, sample_submit=None):
    ...
    train.to_csv('data/output/features/ikki_features_train_ver3.csv',index=None)
    test.to_csv('data/output/features/ikki_features_test_ver3.csv',index=None)

def main_feat_NN():
    train = pd.read_csv('data/output/features/ikki_features_train_ver3.csv')
    test = pd.read_csv('data/output/features/ikki_features_test_ver3.csv')
...
def one_hot_encoder(train, test):
    ...
    train.to_csv('data/output/features/ikki_one_hot_encoder_train_ver3.csv',index=None)
    test.to_csv('data/output/features/ikki_one_hot_encoder_test_ver3.csv',index=None)
